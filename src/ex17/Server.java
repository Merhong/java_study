...
public class Server {
    public static void main(String[] args) {
        ...
        try {
            ...
            out = new PrintWriter(clientSocket.getOutputStream());  // 클라이언트로 데이터를 보내기 위한 PrintWriter 생성
            in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream())); // 클라이언트로부터의 데이터를 읽기 위한 BufferedReader 생성
